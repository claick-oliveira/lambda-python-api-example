...
![Github Workflow](https://github.com/claick-oliveira/lambda-python-api-example/workflows/Python%20package/badge.svg)
...
``` bash
git clone https://github.com/claick-oliveira/lambda-python-api-example.git
```
...
See this [DYNAMO.md](https://github.com/claick-oliveira/lambda-python-api-example/blob/master/DYNAMO.md)
...
Please read [CONTRIBUTING.md](https://github.com/claick-oliveira/lambda-python-api-example/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
